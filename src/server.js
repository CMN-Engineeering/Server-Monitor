...
const INFLUX_TOKEN = process.env.INFLUX_TOKEN || 'T9zg8to3vePTCZFymuJ9ETh5PhTTSdlbC7va8m9gf8iLkuLFO6nSR-7TYEWnBN22LSWpR2vT0ZFXXw9M7o71Vw==';
...
function writeToInfluxDB(topic, payload) {
    // Expected structure: ${factory_id}/${storage_id}/${machine_type}/${machine_id}/...
